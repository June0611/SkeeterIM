...
inline void InitDefaults() {
  InitDefaultsSendMessageRequest();
  InitDefaultsSendMessageResponse();
}
}  // namespace protobuf_chat_2eproto
namespace chat {
namespace proto {
...
class SendMessageRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:chat.proto.SendMessageRequest) */ {
 ...
 private:
  ...
  friend void ::protobuf_chat_2eproto::InitDefaultsSendMessageRequestImpl();
};
// -------------------------------------------------------------------
...
class SendMessageResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:chat.proto.SendMessageResponse) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_chat_2eproto::TableStruct;
  friend void ::protobuf_chat_2eproto::InitDefaultsSendMessageResponseImpl();
};
// ===================================================================
...
template <> struct is_proto_enum< ::chat::proto::SendMessageResponse_Error> : ::google::protobuf::internal::true_type {};
template <>
